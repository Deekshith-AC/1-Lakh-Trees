      ...
      <div className="max-w-6xl mx-auto px-6 bg-white/70 backdrop-blur rounded-lg py-8">
        ...
        <div className="grid grid-cols-3 md:grid-cols-6 gap-8 items-start">
          {IMAGES.partnersLogos.map((l,i)=>(
            <div key={i} className="p-4 flex flex-col items-center text-center filter grayscale hover:grayscale-0 transition">
              ...
              <div className="mt-2 text-xs md:text-sm text-gray-600">Supporting the 1 Lakh Trees mission</div>
            </div>
          ))}
        </div>
      </div>
