  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-b from-green-50 to-white">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center px-6">
        ...
        <div>
          <div className="text-primary font-semibold">Our Village, Our Responsibility</div>
          <h2 className="text-3xl font-bold mt-4">Welcome to Manna Orru Manna Bhadhyatha</h2>
